...
const SportsIndex = () => {
  ...
  events = Object.values(events).filter(event => event.classification.name === "Sports");
    ...
    <div className={styles.mainContainer}>
        ...
        <div className={styles.subHeaderContainer}>
          <div className={styles.homeContainer}>
              <div className={styles.homeTextContainer}>
                ...
                <div className={styles.subTitle}>Sports Tickets</div>
              </div>
          </div>
          <div className={styles.subHeaderTitle}>
            <h1 className={styles.subHeaderTitleText}>
              <span className={styles.concertText}>All Sports </span>
      ...
      <div className={styles.eventsContainer}>
        <div className={styles.eventsTitleContainer}>
          <div className={styles.allConcertsText}>All Sports Events ({events.length})</div>
        </div>
