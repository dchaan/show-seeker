...
const ArtsAndTheatreIndex = () => {
  let events = useSelector(state => state.events.events);
  events = Object.values(events).filter(event => event.classification.name === 'Arts & Theatre');
    ...
    <div className={styles.mainContainer}>
        ...
        <div className={styles.subHeaderContainer}>
          <div className={styles.homeContainer}>
              <div className={styles.homeTextContainer}>
                ...
                <div className={styles.subTitle}>Arts & Theatre Tickets</div>
              </div>
          </div>
          <div className={styles.subHeaderTitle}>
            <h1 className={styles.subHeaderTitleText}>
              <span className={styles.concertText}>All Arts & Theatre </span>
      ...
      <div className={styles.eventsContainer}>
        <div className={styles.eventsTitleContainer}>
          <div className={styles.allConcertsText}>All Arts & Theatre Events ({events.length})</div>
        </div>
...
export default ArtsAndTheatreIndex;
